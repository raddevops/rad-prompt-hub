...
# Test script for add-copilot-instructions prompt
...
# TODO: Implement actual Copilot instructions tests
# This is a template - actual test implementation should:
# 1. Test with sample repository context
# 2. Verify instruction quality and completeness
# 3. Check that all variables/placeholders work correctly
# 4. Validate instruction adherence to best practices
# 5. Test different project types and sizes
