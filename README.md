...
├── code-review.json    # Executable prompt specification (tools consume this)
├── code-review.md      # Documentation about the prompt (humans read this)
└── test.sh             # Quick validation script and usage example
```

- **`.json` file**: Single source of truth for executable prompt specification (tools consume these)
- **`.md` file**: Human-readable documentation ABOUT the prompt (purpose, usage context, integration notes)
